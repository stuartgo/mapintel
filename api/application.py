...
def get_application() -> FastAPI:
    application = FastAPI(title="Mapintel-API", debug=True, version="0.1", root_path=ROOT_PATH)
...
logger.info(
    """
Or just try it out directly: curl --request POST --url 'http://127.0.0.1:8000/query' --data '{"query": "Stock Market News"}'
"""
)
