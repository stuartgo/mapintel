...
\subsection{Dataset}
Some of the evaluation metrics of our systems and its components are dependent on the underlying data. For that reason we provide a dataset of news articles collected as explained in section \ref{indexing}. This dataset contains 334,925 news articles from multiple international sources 
