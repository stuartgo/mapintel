...
\begin{figure}[h!]
  ...
  \resizebox{0.9\textwidth}{!}{%
    \begin{subfigure}[b]{\linewidth}
      ...
      \caption{train data with original labels}
    \end{subfigure}
    \begin{subfigure}[b]{\linewidth}
      \includegraphics[width=\linewidth]{./assets/top_umap_train_plot}
      \caption{train data with topic labels}
    \end{subfigure}
  }
  \resizebox{0.9\textwidth}{!}{%
    \begin{subfigure}[b]{\linewidth}
      \includegraphics[width=\linewidth]{./assets/orig_umap_test_plot}
      \caption{test data with original labels}
    \end{subfigure}
    \begin{subfigure}[b]{\linewidth}
      \includegraphics[width=\linewidth]{./assets/top_umap_test_plot}
      \caption{test data with topic labels}
    \end{subfigure}
  }
  \caption{Comparison between UMAP plots of train and test data with original and topic labels}
  \label{umap_plots}
\end{figure}
