...
Our results based on the setup described are shown in Table \ref{table2}.
\begin{table}[]
  \centering
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{@{}llllll@{}}
      ...
      BERTopic             & \multicolumn{1}{l|}{Doc2Vec} & 0.499               & 0.105          & 0.721                   & 0.224                     \\
      BERTopic             & \multicolumn{1}{l|}{SBERT}   & \textbf{0.942}      & \textbf{0.403} & \textbf{0.763}          & \textbf{0.38}             \\
      CTM                  & \multicolumn{1}{l|}{Doc2Vec} & 0.558               & 0.287          & 0.567                   & 0.235                     \\
      CTM                  & \multicolumn{1}{l|}{SBERT}   & 0.704               & 0.329          & 0.576                   & 0.36                      \\
      LDA                  & \multicolumn{1}{l|}{Doc2Vec} & 0.576               & 0.261          & 0.537                   & 0.249                     \\
      LDA                  & \multicolumn{1}{l|}{SBERT}   & 0.71                & 0.27           & 0.544                   & 0.369                     \\ \bottomrule
    \end{tabular}%
  }
