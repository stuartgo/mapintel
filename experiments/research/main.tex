...
\begin{figure}[H]
  ...
  \resizebox{\textwidth}{!}{%
    \begin{subfigure}[b]{0.44\linewidth}
      ...
      \label{umap_train_plots:a}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\linewidth}
      \includegraphics[width=\linewidth]{./assets/top_umap_train_plot}
      \caption{Topic labels}
      \label{umap_train_plots:b}
    \end{subfigure}
  }
  \caption{Comparison between UMAP planes of \textbf{train data} with original (a) and topic labels (b).}
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{@{}llll@{}}
      ...
      \multirow{3}{*}{"Indian Elections"}  & India elections: Modi party defeated in West Bengal battleground - BBC News                        & 5.36           & 11                     \\
                                           & At 103, India's first voter casts vote in Himachal panchayat radish polls                                 & 4.77           & -1                     \\
