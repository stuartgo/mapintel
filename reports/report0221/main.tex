...
Despite the good empirical results in IR \citep{dumais1988, berry1995}, LSI does not provide a mathematical explanation for its effectiveness, leaving us with unanswered questions regarding the extent to which LSI captures the semantic structure of a corpus \citep{papadimitriou2000}. \citet{hofmann1999} proposes Probabilistic LSI (pLSI),

(Make a case on why LDA is important over LSI) 

% This paragraph talks about clustering and SOM
The VSM model allows the use of clustering ...
