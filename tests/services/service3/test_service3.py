...
def test_model():
    ...
    model.fit(["Obama was the president","Biden is the president","Greece is warmer than Norway","Norway is cold","Portugal is far west","The president is elected","Norway is far north","Greece has many islands","Europe is large","The president has a 4 year term"])
    artifacts = {
        "lda_model": "./tests/services/service3/model.pkl"
    }
...
def test_info():
    ...
    assert "lda_model" in metadata["flavors"]["python_function"]["artifacts"].keys()
